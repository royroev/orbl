			...
			$multiselect.each( function() {
				...
				$selectSave.on( 'click', function() {
					var terms    = [],
						...
						values   = jQuery( this ).parent().find( 'input.fusion-multiselect-input' ).val();
					...
					values            = values.split( ',' );
					ajaxData.taxonomy = $current.parent().find( 'input.fusion-multiselect-input' ).data( 'id' );
					...
					jQuery.post( fusionAppConfig.ajaxurl, ajaxData, function( response ) {
						...
						if ( 'object' === typeof response ) {
							...
							$current.parent().find( 'input.fusion-multiselect-input' ).val( '' );
						}
					} );
				} );
